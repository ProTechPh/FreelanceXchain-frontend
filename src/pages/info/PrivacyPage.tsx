      ...
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="bg-dark-card border border-dark-border rounded-lg p-8">
          ...
          <div className="text-gray-300 space-y-6">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-3">4. KYC Data Processing</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-3">5. Blockchain and Smart Contracts</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-3">6. Information Sharing and Disclosure</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-3">9. Cookies and Tracking</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-3">10. Data Retention</h2>
              <p>
