    ...
    <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="space-y-4">
          <div className="grid sm:grid-cols-2 gap-4">
            <div>
              ...
              <div className="flex items-center gap-2 px-4 py-2 bg-dark-bg border border-dark-border rounded-lg">
          ...
          {user?.role !== 'admin' && (
            <div>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-2 px-4 py-3 bg-dark-bg border border-primary-500/30 rounded-lg">
      ...
      <Card>
        ...
        <div className="space-y-4">
          ...
          <div className="pt-3 space-y-3">
            <p className="text-sm font-medium text-gray-300">Notify me about:</p>
            {[
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full bg-dark-bg border border-dark-border rounded-lg px-4 py-2 pr-10 text-white focus:outline-none focus:border-primary-500"
      ...
      >
        <div className="space-y-4">
          ...
          <p className="text-gray-300">Type <span className="font-mono text-white">DELETE</span> to confirm:</p>
          <Input
