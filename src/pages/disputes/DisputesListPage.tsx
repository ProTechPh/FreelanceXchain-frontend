...
export function DisputesListPage() {
  ...
  return (
    <div className="space-y-6" data-tour-id="disputes-main">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card className="bg-gradient-to-br from-red-50 to-red-100 dark:from-red-900/50 dark:to-dark-surface">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-gray-600 dark:text-gray-400 text-sm">Escalated</p>
              <p className="text-2xl font-bold text-gray-900 dark:text-white">
      ...
      {filteredDisputes.length === 0 ? (
        <Card className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-gray-900 dark:text-gray-400">No disputes found</h3>
