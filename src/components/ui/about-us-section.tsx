...
const PILLARS = [
  {
    icon: <LockKey className="size-6 text-primary" weight="bold" />,
  ...
  {
    icon: <Brain className="size-6 text-primary" weight="bold" />,
  ...
  {
    icon: <Globe className="size-6 text-primary" weight="bold" />,
  ...
  {
    icon: <ShieldCheck className="size-6 text-primary" weight="bold" />,
        ...
        <div className="rounded-3xl bg-primary text-primary-foreground p-8 sm:p-12 text-center relative overflow-hidden shadow-xl">
          <div className="relative z-10 max-w-2xl mx-auto space-y-4">
            ...
            <div className="pt-4 flex flex-wrap items-center justify-center gap-3">
              <Link href="/register">
                <Button className="rounded-full bg-white text-primary hover:bg-white/90 text-xs font-bold px-6 py-3 shadow-md">
                  Get Started Free
                </Button>
              </Link>
              <Link href="/projects">
                <Button variant="outline" className="rounded-full border-white/40 text-white hover:bg-white/10 text-xs font-bold px-6 py-3">
