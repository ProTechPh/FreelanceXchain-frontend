...
import { Bookmark, ExternalLink, Heart, Loader2, Play, Save, Trash2 } from 'lucide-react';
    ...
    <div className="mx-auto max-w-6xl space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <div className="space-y-4">
          {searches.length === 0 ? <Card><CardContent className="py-12 text-center text-muted-foreground">No saved searches yet. Save filters from a marketplace page.</CardContent></Card> : searches.map((search) => {
