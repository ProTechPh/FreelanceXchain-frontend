  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6">
      ...
      <Dialog
        ...
        onOpenChange={(open) => {
          if (!open && !actionId) setSearchToDelete(null);
        }}
      >
