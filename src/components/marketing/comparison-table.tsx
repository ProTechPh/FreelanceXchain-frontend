...
import { Check, Sparkles as Sparkle } from 'lucide-react';
    ...
    <section id="compare" className="py-20 sm:py-28 bg-background border-b border-border/40 scroll-mt-20">
      <div className="mx-auto max-w-5xl px-6 lg:px-8">
        ...
        <div className="block sm:hidden text-center mb-3">
          <span className="text-2xs font-semibold text-muted-foreground bg-muted/60 px-3 py-1 rounded-full border border-border/60">
