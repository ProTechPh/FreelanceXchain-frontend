...
import { Brain, Zap as Lightning, Kanban, ShieldCheck, Sparkles as Sparkle, CircleCheck as CheckCircle, Send as PaperPlaneTilt } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <div className="rounded-xl border border-border bg-background p-4 space-y-3 font-mono text-xs shadow-inner">
              <div className="flex items-center justify-between border-b border-border/60 pb-2 text-2xs text-muted-foreground">
                <span className="flex items-center gap-1.5 text-foreground font-semibold">
                  <Sparkle className="size-3.5 text-primary" fill="currentColor" />
                  Tailored Proposal Scope
                </span>
                <span className="px-2 py-0.5 rounded-full bg-success-subtle text-success font-bold">
                  Skill Match: 99%
                </span>
              </div>
              ...
              <div className="flex items-center gap-2 pt-1 font-sans text-2xs text-muted-foreground">
          ...
          >
            <div>
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-primary/10 text-primary mb-4">
                <PaperPlaneTilt className="size-5" fill="currentColor" />
              </div>
              <span className="text-xs font-bold text-primary uppercase tracking-wider">
                Instant Submissions
              </span>
            ...
            <div className="rounded-xl border border-primary/20 bg-primary/5 p-4 text-center">
              <div className="w-10 h-10 mx-auto rounded-full bg-primary text-primary-foreground flex items-center justify-center mb-2 shadow-sm">
                <Lightning className="size-5" fill="currentColor" />
              </div>
              <p className="text-xs font-bold text-foreground">3.2 Seconds Average</p>
              <p className="text-2xs text-muted-foreground">From review to proposal submission</p>
            </div>
          </motion.div>
          ...
          >
            <div>
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-primary/10 text-primary mb-4">
                <Kanban className="size-5" fill="currentColor" />
              </div>
              <span className="text-xs font-bold text-primary uppercase tracking-wider">
                Live Workspace
              </span>
            ...
            <div className="space-y-2 text-xs">
              ...
              <div className="flex items-center justify-between p-2 rounded-lg bg-success-subtle border border-success-border text-success dark:text-success">
          ...
          >
            <div>
              <div className="flex items-center gap-3 mb-4">
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-primary/10 text-primary">
                  <ShieldCheck className="size-5" fill="currentColor" />
                </div>
                <div>
                  <span className="text-xs font-bold text-primary uppercase tracking-wider">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
              <div className="p-3 rounded-xl bg-background border border-border/80">
                ...
                <p className="text-muted-foreground text-2xs mt-0.5">Funds locked upfront</p>
              </div>
              <div className="p-3 rounded-xl bg-background border border-border/80">
                <p className="font-bold text-foreground">On-Chain Reputation</p>
                <p className="text-muted-foreground text-2xs mt-0.5">Portable across Web3</p>
              </div>
              <div className="p-3 rounded-xl bg-background border border-border/80">
                <p className="font-bold text-foreground">Global Didit KYC</p>
                <p className="text-muted-foreground text-2xs mt-0.5">Verified across 220+ countries</p>
              </div>
            </div>
          </motion.div>
        </div>
