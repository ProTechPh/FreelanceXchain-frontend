...
const CheckIcon = () => (
    <svg className="w-4 h-4 text-gradient-foreground" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-dvh w-full bg-background">
      ...
      <div className="hidden lg:flex lg:w-[45%] relative overflow-hidden">
        {/* Gradient background */}
        <div className="absolute inset-0 bg-gradient-to-br from-primary via-primary to-chart-2 dark:from-gradient-from dark:via-gradient-via dark:to-gradient-to" />
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 lg:p-16 text-gradient-foreground w-full">
          {/* Logo */}
          <Link href="/" className="flex items-center gap-2.5 hover:opacity-90 transition-opacity">
            <FreelanceXchainLogo iconSize={36} className="text-gradient-foreground [&_span]:text-gradient-foreground" />
          </Link>
          
          {/* Content */}
          <div className="max-w-lg">
            {/* Badge */}
            <div className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-gradient-foreground/15 text-gradient-foreground text-xs font-bold mb-6 border border-gradient-foreground/20 backdrop-blur-sm">
              <Sparkles className="size-3.5" fill="currentColor" />
              <span>Join the Future of Work</span>
            </div>
            
            {/* Heading */}
            <h2 className="text-4xl lg:text-5xl font-extrabold leading-tight tracking-tight mb-5 text-gradient-foreground">
              Start your decentralized freelance journey today
            </h2>
            
            {/* Description */}
            <p className="text-lg leading-relaxed mb-10 text-gradient-foreground/60 dark:text-gradient-foreground/90">
            ...
            <div className="flex flex-col gap-4">
              {features.map((feature) => (
                <div key={feature} className="flex items-center gap-4">
                  <div className="w-10 h-10 rounded-xl bg-gradient-foreground/15 flex items-center justify-center shrink-0 backdrop-blur-sm">
                    <CheckIcon />
                  </div>
          ...
          {/* Footer */}
          <p className="text-gradient-foreground/60 dark:text-gradient-foreground/90 text-sm">
